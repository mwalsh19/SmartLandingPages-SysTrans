...
<?php
    ...
    Yii::app()->clientScript->registerLinkTag("icon","image/x-icon", $assets . '/' . $name . '-favicon.ico');
    ?>
            ...
            <div id="sub-heading" class="sub-heading" data-name="<?php if(!strpos($data->type, 'VB')) {echo $name;} ?>">
                <div class="sub-heading-wrap clearfix">
                    ...
                    <div class="sub-heading-phone">
                        ...
                        <h1 onclick="gtag_report_conversion()" style="color: <?php echo $primary_color ?>"><?php echo $data->phone ?></h1>
                    </div>
                </div>
            </div>
            ...
            <div class="footer-container">
                <div class="footer-wrap">
                    <div class="phone-number-footer">
                        ...
                        <h3 onclick="gtag_report_conversion()" style="color: <?php echo $primary_color ?>">
                            <?php echo $data->phone ?>
                        </h3>
                    </div>
                    <div class="terms">

...
<div class="form-group">
    <label class="col-sm-2 control-label required">Heading</label>
    <div class="col-sm-10">
        <?php
        $this->widget('ext.ckeditor.CKEditorWidget', array(
            "model" => $model, # Data-Model
            "attribute" => 'heading', # Attribute in the Data-Model
            'defaultValue' => $model->heading,
            "config" => array(
                "height" => "150px",
                "width" => "auto",
        ...
        ?>
        <?php echo $form->error($model, 'heading', array('class' => 'help-block errorMessage')); ?>
...
<?php
echo $form->hiddenField($model, 'header_logo', array('class' => 'form-control'));
...
echo $form->hiddenField($model, 'footer_logo', array('class' => 'form-control'));

...
class MIntermodal extends MIntermodalBase {
    ...
    public function rules() {
        return array(
            array('type, referral_code, intelliapp_referral_code, main_title, main_description, benef1_caption, benef2_caption, benef3_caption, benef4_caption, benef5_caption, benef6_caption, body_copy, phone', 'required'),
            ...
            array('sub_title, ga_lp, ga_tp', 'required', 'message' => 'The field is required', 'on' => 'isSpecialOffer'),
            array('map_address, lat, lng', 'required', 'message' => 'The field is required.', 'on' => 'isNotSpecialOffer'),
            ...
            array('background', 'file', 'safe' => true, 'types' => 'jpg, png', 'maxSize' => 5242880, 'tooLarge' => Yii::t('general', 'The file size exceeds the allowed'), 'wrongType' => Yii::t('general', 'Only allow files with extension jpg'), 'allowEmpty' => true, 'on' => 'update'),
            array('h_b_1, h_b_2, h_b_3, h_b_4, h_b_5, h_b_6, h_b_7, id_master, map_source, search_address_input, sub_title, ga_lp, ga_tp', 'safe')
        );
    }

...
/**
 * This is the model class for table "tbl_leads".
 *
 * The followings are the available columns in table 'tbl_leads':
 ...
 */
class MLeads extends CActiveRecord {
    ...
    public function rules() {
        ...
        return array(
            array('referral_code, state, city, leads, date', 'required'),
            ...
            array('id_lead, referral_code, state, city, leads', 'safe', 'on' => 'search'),
        );
    }
     ...
     * @return MLeads the static model class
     */

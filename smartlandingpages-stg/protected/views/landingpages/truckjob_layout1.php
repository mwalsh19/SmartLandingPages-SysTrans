        ...
        <div class="row-fluid interchange">
            <div class="span8">
                <div class="lftcon">
                    ...
                    <div class="innercon">
                        <section class="hero hero-student" style="background: url(<?php echo $directory ?>/img/swift/<?php echo $data->background ?>) center center no-repeat fixed">
                            <?php echo $data->content ?>
                        </section>
                        <section class="main-content">
                            <h3>Earn your Class A-CDL license, at Swift</h3>
                            <p>When you work with Swift, you’re investing in your truck driving career with some of the best pay packages and training in the trucking industry. When you join team Swift everything changes. No credit checks, great incentives, modern equipment and a place to truly grow. Don’t wait.</p>
                            <ul class="benefits">
                                <li><span>No Money Down or Credit Check</span></li>
                                <li><span>New Classes Start Weekly</span></li>
                                <li><span>Certified Mentors Ready and Available</span></li>
                                <li><span>Paid (While Training With Mentor)</span></li>
                                <li><span>Regional and Dedicated Opportunities</span></li>
                                <li><span>Excellent Benefits Package and Perks</span></li>
                            </ul>

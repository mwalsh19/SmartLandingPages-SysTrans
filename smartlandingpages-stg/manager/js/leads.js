var datePicker = $(document).find('#datePicker'), date_param, filter_param, filter_param_value, option_selected, hasfilter,
        dateSelected;
...
//    console.log(filter_param_value);
    if (hasfilter) {
        ...
        window.location =
                location.protocol + "//" + location.host + location.pathname + '?' + filter_param + date_param;
    } else {

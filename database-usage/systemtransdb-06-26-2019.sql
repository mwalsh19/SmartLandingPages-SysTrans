...
--
-- Host: localhost
-- Generation Time: Jun 26, 2019 at 07:39 AM
...
CREATE TABLE `tbl_intermodal` (
  ...
  `id_master` int(10) UNSIGNED NOT NULL,
  `type` enum('ST1','ST2','STTeam','JJW1','TWT1','TWT2','TWT3','LP1B','D','DT','I','SO','SOR') NOT NULL,
...
(1175, 'twt-experienced-cdl-a-drivers-heavy-haul', 'TWT Experienced Heavy Haul Base', 'TWT | Experienced CDL A Drivers | Heavy Haul', 'tbl_intermodal', 0, 1, NULL, '2019-06-26 03:43:34'),
...
--
ALTER TABLE `tbl_intermodal`
  MODIFY `id_intermodal` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=146;
...
--
ALTER TABLE `tbl_master`
  MODIFY `id_master` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1177;

--
-- AUTO_INCREMENT for table `tbl_output_xml`
--
ALTER TABLE `tbl_output_xml`
  MODIFY `id_output` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=30;
